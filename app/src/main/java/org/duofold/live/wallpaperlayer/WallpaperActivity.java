...
public class WallpaperActivity extends Activity {
 ...
 final Runnable poll=new Runnable(){public void run(){try{backgroundStatus.setText((WallpaperRestore.enabled(WallpaperActivity.this)?"Enabled":"Disabled")+" · "+WallpaperRestore.status);}catch(Exception e){backgroundStatus.setText("Background status unavailable. Copy the background report for details.");}h.postDelayed(this,1000);}};
