...
public class LayerHost extends Binder {
 public static final String TOKEN="com.consorti.wallpaperlayer.Host";
 ...
 final Set<Float> angles=Collections.synchronizedSet(new HashSet<>()); final String action="com.consorti.wallpaperlayer.READ_"+SystemClock.elapsedRealtime();
