...
public class HostLauncher extends Binder {
 public static final String TOKEN="com.consorti.wallpaperlayer.Launcher";
 ...
 synchronized void startTest(){
  ...
  new Thread(()->{
   ...
   try{
    ...
    test=new ProcessBuilder("am","instrument","-w","-r","--no-restart","--no-hidden-api-checks","com.consorti.foliofold/com.consorti.wallpaperlayer.PhotoInstrumentation").redirectErrorStream(true).start();
