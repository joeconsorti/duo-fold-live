     ...
     Column(Modifier.fillMaxSize().safeDrawingPadding().verticalScroll(rememberScrollState()).padding(24.dp),verticalArrangement=Arrangement.spacedBy(14.dp)){
      ...
      when(stage){
       0->{
        ...
        Text("Automatic setup currently supports SM-F971U on Android 17. Other models need a verified wallpaper profile before they can use this setup.",style=MaterialTheme.typography.bodySmall)
       ...
       3->{
        ...
        Button(onClick={
         ...
         if(custom&&hasPhoto)startActivity(Intent(this@SetupActivity,com.consorti.wallpaperlayer.WallpaperActivity::class.java).putExtra("auto_enable",true))
         finish()
