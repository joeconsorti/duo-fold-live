...
class FrameSmoothingTest {
 ...
 @Test fun invalidSmoothnessUsesDefault(){assertEquals(30f,FrameSmoothing.sanitize(Float.NaN),0f);assertEquals(12f,FrameSmoothing.sanitize(-1f),0f);assertEquals(120f,FrameSmoothing.sanitize(999f),0f)}
